...
2. 用这个命令进行环境安装:
   ...
   ```
3. 模型安装：将fish-speech原项目的checkpoints文件夹覆盖ComfyUI_windows_portable\ComfyUI\models\fish_speech\checkpoints文件夹
4. 如需开启编译功能，需要安装fish-speech的官方环境。然后用其中的run_cmd.bat安装ComfyUI的环境，再运行ComfyUI\main.py.
